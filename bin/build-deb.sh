...
mkdir -p "${DEB_DIR}/usr/lib/systemd/system-generators"
...
install -m 0755 packaging/backupchief-cpu-quota-generator "${DEB_DIR}/usr/lib/systemd/system-generators/backupchief-cpu-quota-generator"
