...
func writeEnrollmentResponse(response http.ResponseWriter, status int) {
	...
	_, _ = io.WriteString(response, `{"protocol_revision":"1.2.0","server_id":"01k4p4f7m1r9d3t6v8w2x5y7za","generation":1,"enrolled_at":"2026-09-09T08:15:00.000000Z","config_revision":1}`)
}
