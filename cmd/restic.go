...
func newResticCommand() *cobra.Command {
	...
	command := &cobra.Command{
		...
		RunE: func(command *cobra.Command, _ []string) error {
			return runResticCommand(command, state, developmentBinary, requestFile, allowLocal)
		},
	}
	...
	command.Flags().StringVar(&developmentBinary, "development-restic", "", "Verified macOS development restic executable")
...
func runResticCommand(
	...
	runner := restic.Runner{
		State:             state,
		DevelopmentBinary: developmentBinary,
